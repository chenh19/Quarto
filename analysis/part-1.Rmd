...
pcplink = read.table(
  glue::glue("./pca.eigenvec"),
  header=F, as.is=T)
names(pcplink) = c("FID","IID",paste0("PC", c(1:(ncol(pcplink)-2))))
pcplink = popinfo %>% 
  inner_join(pcplink, by=c("FID"="FID", "IID"="IID"))
pcplink %>% 
...
![](blob:https://github.com/ac93f223-12a5-4d14-a587-5f35a531d50b){fig-align="center" width="80%"}